...
if __name__ == "__main__":    
    ...
    trDs = allDs.map(shear, num_parallel_calls=tf.data.experimental.AUTOTUNE)
    trDs = trDs.map(prepareInput, num_parallel_calls=tf.data.experimental.AUTOTUNE) #tf.data.experimental.AUTOTUNE
    #trDs = trDs.take(1000)
